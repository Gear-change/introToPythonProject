...
def mainApp():
    ...
    PIFrame = makePersonalInformationtab(tab1, firstName, middleInitial, lastName, userLinkedin, 
    ...
    newFrame = skillFrame(tab4)
    newFrame.grid(column=0, row=0)

    #projectTab

    newFrame = makeOtherTab(tab5)
    newFrame.grid(column=0, row=0)

    # ... Now the fun begins.
    newFrame = makeSettingsTab(tab6)
    newFrame.grid(column=0, row=0)
